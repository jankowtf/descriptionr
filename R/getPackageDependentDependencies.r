#' Get Package Dependent Dependencies
#'
#' @description 
#' Get package dependencies as stated via the \code{Depends} section.
#' 
...
#' @example inst/examples/getPackageDependentDependencies.R
#' @export getPackageDependentDependencies
setGeneric(name="getPackageDependentDependencies", 
  signature = c(
    "from"
  ),
  def = function(
  ...
  standardGeneric("getPackageDependentDependencies")
})
...
setMethod(f = "getPackageDependentDependencies", 
  ...
  tmp <- getPackageDescription(from = from, fields = "Depends", drop = TRUE, ...)
  if (is.na(tmp)) {
    return(tmp)
  }
...
setMethod(f = "getPackageDependentDependencies", 
  ...
  getPackageDependentDependencies(from = from, type = type, ...)
